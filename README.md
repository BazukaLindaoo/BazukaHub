...
-- Funsão para limpar o sofÃ¡ (couch)
                ...
                if targetHumanoid and targetHumanoid.Sit then  
                    ...
                    if bus then
                        ...
                        if originalPosition then
                            ...
                            print("Player voltou para a posisão inicial Xique")  
                    ...
                    local lateralOffset = math.sin(time) * 10  -- Movimento lateral rapido  
                    local frontBackOffset = math.cos(time) * 20  -- Movimento frente/tras
...
-- Funsão para teletransportar o jogador de volta Ã  posisão inicial após 10 segundos
task.delay(14, function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(initialPosition)
end)

-- Funsão para limpar todas as ferramentas 0.5 segundos após teletransporte para a posisão inicial
...
-- Variavel para controlar o estado do toggle House RGB
local isHouseRGBActive = false

-- Funsão para alterar a cor da casa
...
-- Funsão para obter lista de casas
...
-- Funsão para atualizar a lista de casas
...
pcall(function()
    HouseTab:AddToggle({
        ...
        Default = false,
        Callback = function(Value)
            getgenv().BazukaHubAutoSpawnDoorbellValue = Value
            spawn(function()
                while getgenv().BazukaHubAutoSpawnDoorbellValue do
                    local House = workspace["001_Lots"]:FindFirstChild(tostring(SelectHouse))
                    if House and House:FindFirstChild("HousePickedByPlayer") then
...
pcall(function()
    HouseTab:AddToggle({
        ...
        Default = false,
        Callback = function(Value)
            getgenv().BazukaHubAutoSpawnDoorValue = Value
            spawn(function()
                while getgenv().BazukaHubAutoSpawnDoorValue do
                    local House = workspace["001_Lots"]:FindFirstChild(tostring(SelectHouse))
                    if House and House:FindFirstChild("HousePickedByPlayer") then
...
Tab:AddTextBox({
    Name = "Insira o ID do Ãudio ou Musica",
...
-- Nova sesão para loop de áudio
Tab:AddSection({"Loop de Audio"})

-- Funsão para tocar o áudio repetidamente
...
-- Adicionar um parÃ¡grafo como label
Tab:AddParagraph({"Info", "Loop de tocar Ãudio (Todos players do Server ouvem)"})

-- Funsão para tocar o áudio normal
...
-- Nova sesão para tocar áudio
Tab:AddSection({"Tocar Ãudio"})

-- Botão para tocar o áudio
Tab:AddButton({"Tocar Ãudio", function()
    playAudio()
end})
...
local function Audio_All_ClientSide(ID)
    ...
    local function CreateSound(ID)
        if type(ID) ~= "number" then
            print("Insira um número vÃ¡lido!")
            return nil
        end
...
Tab:AddToggle({
    ...
    Callback = function(value)
        ...
        while getgenv().Audio_All_loop_fast do
            ...
            task.wait(0.03) -- Delay extremamente rapido (0.03 segundos)
        end
    end
})
...
Tab:AddButton({
    ...
    Callback = function()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", {
            ...
            Text = "Shutdown concluido, Agora Vai Desligar",
            Button1 = "Ok",
            Duration = 5
        })
        wait()
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "Script de Dupe",
            Text = "Iniciando duplicasão, seja paciente",
            Button1 = "Ok",
            Duration = 5
        })
        wait(0.5)
...
CarTab:AddParagraph({"Informasão:", "Recomendo usar 2 vezes para garantir que todos os veÃ­culos sejam removidos"})
...
CarTab:AddParagraph({"Informasão:", "Puxa todos os carros do servidor atÃ© você"})
...
botaoMinimizar.Text = "-"  -- Inicia com o simbolo de "-"
...
CarTab:AddParagraph({"Informasão:", "Ambos os turbos não precisam de Gamepass"})
...
CarTab:AddParagraph({"Note", "O script de mÃºsica funciona em todos os carros e casas"})
...
CarTab:AddParagraph({"Note", "Ativando isso deixarÃ¡ seu carro RGB"})
...
CarTab:AddParagraph({"Informasão:", "Spamar vÃ¡rios carros"})
...
-- Funsão para atualizar a lista de players
...
-- Aba Child
local ChildTab = Window:MakeTab({"CrianÃ§a", "baby"})
...
-- Eventos de entrada/saÃ­da de players
...
ChildTab:AddButton({
    ...
    Callback = function()
        ...
        if not workspace:FindFirstChild(pl.Name) or not workspace[pl.Name]:FindFirstChild("FollowCharacter") then
            ...
            if not success then
                warn("Erro ao enviar crianÃ§a: " .. err)
            end
        end
...
ChildTab:AddButton({
    ...
    Callback = function()
        ...
        if not success then
            warn("Erro ao retornar crianÃ§a: " .. err)
        end
        ...
        if not success then
            warn("Erro ao spawnar crianÃ§a: " .. err)
        end
    end
})
...
LocalPlayerTab:AddTextBox({
    ...
    Callback = function(value)
        ...
        if speed and pl.Character and pl.Character:FindFirstChild("Humanoid") then
            ...
            warn("Velocidade invÃ¡lida ou personagem não encontrado!")
        end
    end
})
...
LocalPlayerTab:AddTextBox({
    ...
    Callback = function(value)
        ...
        if jumpHeight and pl.Character and pl.Character:FindFirstChild("Humanoid") then
            ...
            warn("Altura de pulo invÃ¡lida ou personagem não encontrado!")
        end
    end
})
...
getgenv().BazukaHubEnviarDelay = 1
...
LocalPlayerTab:AddSlider({
    ...
    Increment = 0.1,
    Callback = function(Value)
        getgenv().BazukaHubEnviarDelay = Value
    end
})
...
LocalPlayerTab:AddToggle({
    ...
    Callback = function(Value)
        getgenv().BazukaHubSpawnText = Value
        while getgenv().BazukaHubSpawnText do
            sendchat(TextSave)
            task.wait(getgenv().BazukaHubEnviarDelay)
        end
    end
})
...
LocalPlayerTab:AddButton({
    ...
    Callback = function()
        if game:GetService("TextChatService").ChatVersion == Enum.ChatVersion.TextChatService then 
            game:GetService("TextChatService").TextChannels.RBXGeneral:SendAsync("hi\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\rServer: Hacked by Bazuka Hub")
        else 
            print("Nadaa")
    end
end
...
local Tab = Window:MakeTab({"Teleportes", "tp"}) -- Nome do Ã­cone: 'portal' em minÃºsculo para teleporte

-- BotÃµes de Teleporte
local teleportButtons = {
    {"Aos Bastidores", CFrame.new(192, 4, 272)},
    {"Ao Centro Urbano", CFrame.new(136, 4, 117)},
    {"Ã€ Ãrea do Crime", CFrame.new(-119, -28, 235)},
    {"Ã€ Casa Deserta", CFrame.new(986, 4, 63)},
    {"Ao Portal da AgÃªncia", CFrame.new(672, 4, -296)},
    {"Ao Esconderijo", CFrame.new(505, -75, 143)},
    {"Ã€ Escola", CFrame.new(-312, 4, 211)},
    {"Ao CafÃ© Brook", CFrame.new(161, 8, 52)},
    {"Ao Ponto Inicial", CFrame.new(-26, 4, -23)},
    {"Ao Arco Principal", CFrame.new(-589, 141, -59)},
    {"Ao Hospital", CFrame.new(-309, 4, 71)},
    {"Ã€ Base da AgÃªncia", CFrame.new(179, 4, -464)},
    {"Ã€ Sala Oculta da Oficina", CFrame.new(0, 4, -495)},
    {"Ã€ Sala Secreta 2", CFrame.new(-343, 4, -613)},
    {"Ã€ Ilha Isolada", CFrame.new(-1925, 23, 127)},
    {"Ã€ PraÃ§a dos HotÃ©is", CFrame.new(182, 4, 150)},
    {"Escalar Montanha 1", CFrame.new(-670, 251, 765)},
    {"Ao Banco Principal", CFrame.new(2.28, 4.65, 254.58)},
    {"Ã€ Loja de Roupas", CFrame.new(-46.15, 4.65, 253.20)},
    {"Ao RefÃºgio", CFrame.new(-88.48, 22.05, 262.34)},
    {"Ã€ ClÃ­nica DentÃ¡ria", CFrame.new(-53.58, 22.15, 265.61)},
    {"Ã€ Cafeteria", CFrame.new(-97.12, 4.65, 254.99)}
}
...
if toolCount >= dupeamot then
    -- Desequipa e move as ferramentas para as posisãµes definidas
...
ToolsTab:AddButton({
    Name = "Colorir Mapa CÃ©u [Muito OP]",
    Callback = function()
       local toolselected = "PaintRoller"
local dupeamot = 100
local picktoolremote = game:GetService("ReplicatedStorage").RE:FindFirstChild("1Too1l")
...
-- Variavel para armazenar a cor selecionada
local selectedColor = colorsTable[1].Color

-- Funsão para aplicar a cor selecionada
...
-- Funsão para equipar e desequipar ferramentas
...
ToolsTab:AddDropdown({
    ...
    Description = "Escolha uma combinasão de cores",
    Options = (function()
...
-- Referencias aos remotes
local cleartoolremote = game:GetService("ReplicatedStorage").RE:FindFirstChild("1Clea1rTool1s")
local picktoolremote = game:GetService("ReplicatedStorage").RE:FindFirstChild("1Too1l")

-- Sesão de controle de itens
...
game:GetService("StarterGui"):SetCore("SendNotification",{Title="Dupe Script",Text="Please do not equip any tools or unequip tools or click tools on inventory. It will break the script.", Button1 = "I understand" ,Duration=5})
                ...
                for m=1, 124 do
                        ...
                        if duping == false then game.Players.LocalPlayer.Character.HumanoidRootPart.Anchored = false return end
                        wait()
                        game:GetService("Players").LocalPlayer.Character[toolthatiwanttodupe]:FindFirstChild("Handle").Name = "HÃƒÂ¢Ã‚ÂÃ‚Â¥aÃƒÂ¢Ã‚ÂÃ‚Â¥nÃƒÂ¢Ã‚ÂÃ‚Â¥dÃƒÂ¢Ã‚ÂÃ‚Â¥lÃƒÂ¢Ã‚ÂÃ‚Â¥e"
                        game:GetService("Players").LocalPlayer.Character:FindFirstChild(toolthatiwanttodupe).Parent = game.Players.LocalPlayer.Backpack
                        game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(toolthatiwanttodupe).Parent = game.Players.LocalPlayer.Character
                        repeat                 if game:GetService("Workspace"):FindFirstChild("Camera") then
        ...
        for i, tool in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
            if tool:IsA("Tool") then
                ...
                if tool:IsDescendantOf(game.Players.LocalPlayer.Character) then
                    ...
                    warn("Ferramenta ", tool.Name, " não estÃ¡ no personagem.")
                end
            end
        end
    end
...
UniversalTab:AddButton({
    Name = "Fly Gui",
    Callback = function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/BazukaLindaoo/fly/refs/heads/main/README.md"))()
    end
})
